...
const CounselorSignIn: React.FC = () => {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            localStorage.setItem('lumyn_role', 'counselor');
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-c-background-light dark:bg-background-dark p-4">
            <div className="w-full max-w-md">
                <div className="flex flex-col items-center justify-center gap-4 text-center mb-8">
                    <Link to="/" className="flex items-center gap-3 text-text-light dark:text-text-dark">
                        <div className="size-8 text-c-primary">
                            <span className="material-symbols-outlined !text-4xl">psychology</span>
                        </div>
                        <h2 className="text-3xl font-bold tracking-[-0.015em]">Lumyn for Counselors</h2>
                    </Link>
                ...
                <div className="bg-white dark:bg-neutral-dark/40 p-8 rounded-xl border border-neutral-light dark:border-neutral-dark/80 shadow-soft">
                 ...
                 <div className="text-center mt-6">
                     <Link to="/student-signin" className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary">
                        Not a counselor? Sign in here.
                     </Link>
                </div>
            </div>
        </div>
